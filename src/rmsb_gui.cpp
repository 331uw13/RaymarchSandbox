...
void RMSBGui::init(const char* font_filepath) {
    ImGui::CreateContext();
    ...
    colors[ImGuiCol_ChildBg]                = ImVec4(0.08f, 0.08f, 0.08f, 0.96f);
    colors[ImGuiCol_FrameBg]                = ImVec4(0.13f, 0.12f, 0.12f, 0.54f);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.13f, 0.13f, 0.13f, 0.83f);
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.08f, 0.18f, 0.18f, 0.67f);
    colors[ImGuiCol_SliderGrab]             = ImVec4(0.19f, 0.36f, 0.25f, 0.64f);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.17f, 0.59f, 0.40f, 0.62f);
    colors[ImGuiCol_Button]                 = ImVec4(0.25f, 0.25f, 0.25f, 0.40f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.36f, 0.36f, 0.36f, 0.58f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.09f, 0.30f, 0.30f, 1.00f);
    colors[ImGuiCol_Header]                 = ImVec4(0.24f, 0.24f, 0.24f, 0.31f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.29f, 0.29f, 0.29f, 0.80f);
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.22f, 0.41f, 0.41f, 1.00f);
    colors[ImGuiCol_Separator]              = ImVec4(0.14f, 0.48f, 0.48f, 0.50f);
    colors[ImGuiCol_Tab]                    = ImVec4(0.12f, 0.23f, 0.21f, 0.86f);
    ...
    io.Fonts->AddFontFromFileTTF(font_filepath, 16);
